...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        //Creo que es para establecer la velocidad normal
        ...
        {   //si el personaje no tiene el control, ellos no reaccionan, asi que no los persiguas
            ...
            //sirve para construir el angulo
            ...
            //se construye el angulo de vista
            float angle = Vector3.Angle(testForward, dir);
            //El angulo de la posición del jugador supera el angulo de vista, si si entonces salgase porque no lo vemos
